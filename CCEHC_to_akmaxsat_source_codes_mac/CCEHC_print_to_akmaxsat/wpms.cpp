...
int main(int argc, char* argv[])
{
	...
	*/ 
	...
	{	 
		 ...
		 //printf("%d 0 %lld ", i+1, opt_unsat_weight);
		 printf("%d 0 ", i+1);
		 if(opt_unsat_weight<=total_soft_weight) printf("%lld ", opt_unsat_weight);
		 else printf("%lld ", top_clause_weight+1);
		 int v;
